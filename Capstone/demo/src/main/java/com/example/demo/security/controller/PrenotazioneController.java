...
public class PrenotazioneController {
    ...
    @PostMapping("/post/{nomeUtente}/{data}")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<?> addPrenotazione(@PathVariable String nomeUtente, @PathVariable LocalDate data){

        Prenotazione p = svc.addPrenota(nomeUtente, data);
